    ...
    <div class="navigation">
        ...
        <div>
            <ul class="nav_ul">
                ...
                <a href='../introduction/introduction-of-subject.php'><li class="nav_ul_li">专业介绍</li></a>
...
EOF;
echo $b;
echo "<a href='../index.php'><span>首页<</span></a><span>入学准备</span></div><div class='content_intro'>";
